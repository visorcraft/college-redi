...
export const WIZARD_STEPS: readonly WizardStepDef[] = [
  ...
  { n: 5, id: 'smtp', title: 'Outbound email', skippable: true,
    redi: 'Where should I send summaries and reminders?<br />Your everyday email is perfect.' },
  ...
  { n: 7, id: 'degree', title: 'Your degree', skippable: true,
    redi: 'Tell me about your degree. You can import your audit with AI, or add by hand later.' },
  ...
  { n: 9, id: 'notifications', title: 'Notification style', skippable: true,
    redi: 'When should I buzz you?<br />I hold non-urgent things during quiet hours.' },
